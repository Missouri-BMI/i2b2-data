/*********************************************************
*         SNOWFLAKE SCRIPT TO CREATE ACT METADATA TABLES
...
CREATE TABLE ACT_LOINC_LAB_PROV_V4 (
        C_HLEVEL                              INT    NOT NULL,
        C_FULLNAME                    VARCHAR(700)   NOT NULL,
        C_NAME                                VARCHAR(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_ICD10PCS_PX_V4 (
        C_HLEVEL                              INT    NOT NULL,
        C_FULLNAME                    VARCHAR(700)   NOT NULL,
        C_NAME                                VARCHAR(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_ICD10CM_DX_V4 (
        C_HLEVEL                              INT    NOT NULL,
        C_FULLNAME                    VARCHAR(700)   NOT NULL,
        C_NAME                                VARCHAR(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
...
CREATE TABLE ACT_VISIT_DETAILS_V4 (
        C_HLEVEL                              INT    NOT NULL,
        C_FULLNAME                    VARCHAR(700)   NOT NULL,
        C_NAME                                VARCHAR(2000)  NOT NULL,
        C_SYNONYM_CD                  CHAR(1) NOT NULL,
