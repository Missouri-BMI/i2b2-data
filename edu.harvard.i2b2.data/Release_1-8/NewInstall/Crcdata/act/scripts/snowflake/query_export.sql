/*==============================================================*/
/* QT_BREAKDOWN_PATH seed data                                  */
/* (converted from PostgreSQL — $XML$ dollar-quoting replaced   */
/*  with standard single quotes, internal quotes doubled)       */
/*==============================================================*/

INSERT INTO QT_BREAKDOWN_PATH (NAME, VALUE, CREATE_DATE, UPDATE_DATE, USER_ID) VALUES
